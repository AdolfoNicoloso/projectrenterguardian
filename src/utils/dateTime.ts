...
export function toDateTimeIso(
  ...
  if (!(date instanceof Date) || isNaN(date.getTime())) {
    throw new Error('Invalid date provided to toDateTimeIso');
  }
 ...
 */
export function fromDateTimeIso(
  iso: string | null | undefined
): Date | null {
  if (!iso) {
    return null;
...
/** @deprecated Use toDateTimeIso */
export const toCmsDateTimeIso = toDateTimeIso;
/** @deprecated Use fromDateTimeIso */
export const fromCmsDateTimeIso = fromDateTimeIso;
